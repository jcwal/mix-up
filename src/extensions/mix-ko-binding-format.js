...
(function () {
    ...
    function resolveFormatValueAccessor(valueAccessor, options) {
        ...
        $($.isArray(theValue) ? theValue : [theValue]).each(function (index, value) {
            ...
            if ($.isFunction(options.format)) {
                ...
                } else if (value instanceof Date || ko.defaults.format['Date'][options.format]) {
    ...
    var originValueUpdate = ko.bindingHandlers['value']['init'];
    ko.bindingHandlers['value']['init'] = function (element, valueAccessor, allBindingsAccessor) {
        updateFormatBinding(element, valueAccessor, allBindingsAccessor, function (el, formatValueAccessor) {
            originValueUpdate(el, formatValueAccessor,allBindingsAccessor);
        });
    };

    var originTextUpdate = ko.bindingHandlers['text']['init'];
    ko.bindingHandlers['text']['init'] = function (element, valueAccessor, allBindingsAccessor) {
        updateFormatBinding(element, valueAccessor, allBindingsAccessor, function (el, formatValueAccessor) {
            originTextUpdate(el, formatValueAccessor,allBindingsAccessor);
        });
    }
